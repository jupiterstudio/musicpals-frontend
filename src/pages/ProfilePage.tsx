    ...
    const fetchUserData = async () => {
      ...
      try {
        ...
        const mockAchievements: Achievement[] = [
          {
            ...
            unlockedDate: 'February 10, 2025',
            icon: 'award',
          },
          {
            name: 'Melody Maker',
            description: 'Generate your first original melody',
            unlockedDate: 'February 5, 2025',
            icon: 'music',
          },
          {
            name: 'Theory Scholar',
            description: 'Complete all basic music theory lessons',
        ...
        const mockModuleProgress: ModuleProgress[] = [
          {
            moduleType: 'EarTraining',
            progress: 65,
            lastUpdated: 'March 25, 2025',
            exercises: [
              { id: 1, name: 'Interval Recognition', score: 80, completedDate: 'March 25, 2025' },
              { id: 2, name: 'Chord Identification', score: 75, completedDate: 'March 20, 2025' },
              { id: 3, name: 'Melodic Dictation', score: 60, completedDate: 'March 15, 2025' },
            ],
          },
          {
            moduleType: 'SightSinging',
            progress: 40,
            lastUpdated: 'March 22, 2025',
            exercises: [
              { id: 1, name: 'Simple Scales', score: 90, completedDate: 'March 22, 2025' },
              { id: 2, name: 'Basic Intervals', score: 65, completedDate: 'March 18, 2025' },
              { id: 3, name: 'Simple Melodies', score: 50, completedDate: 'March 10, 2025' },
            ],
          },
          {
            moduleType: 'MusicGeneration',
            progress: 80,
            lastUpdated: 'March 26, 2025',
            exercises: [
              {
                id: 1,
                name: 'Create a Simple Melody',
                score: 100,
              ...
              },
              {
                ...
                score: 85,
                completedDate: 'March 24, 2025',
              },
              {
                id: 3,
                name: 'Generate a Chord Progression',
                score: 75,
                completedDate: 'March 21, 2025',
              },
            ],
          },
          {
            ...
            exercises: [
              {
                id: 1,
                name: 'Introduction to Music Notation',
                score: 100,
                completedDate: 'March 23, 2025',
              },
              { id: 2, name: 'Understanding Rhythm', score: 90, completedDate: 'March 19, 2025' },
              { id: 3, name: 'Major and Minor Scales', score: 85, completedDate: 'March 14, 2025' },
            ],
          },
        ];
